...
import img from '../images/ConstructionMaterials.jpg'; 
import img2 from '../images/engineerInASite.jpg';
import img3 from '../images/emptyPlot.jpeg';
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Construction Materials</h2>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img2} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Construction Consultation</h2>
                                    <p className="text-md font-medium">
                                        We provide high-quality plans and consultation to construct you dream home or any construction project that you dream of.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    ...
                                    <h2 className="font-semibold my-4 text-2xl text-center ">Real Estate</h2>
                                    <p className="text-md font-medium">
                                        We provide high quality approved land registration services to individuals and organizations to enable them gain profit for their investment.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    With over 25 years experience in the field of construction and delivery of Construction Materials and a deep understanding of the latest trends , we provide customized recommendations and strategies to help you improve your operations, reduce costs, and increase efficiency.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>We can collaborate with your existing team to scale existing plans or design customized projects that suits your needs and simplifies various processes.</p>
                            </div>
                        </div>
                    </div>
                </div>
