                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            {/* We build digital solutions to help businesses scale */}
                                Sai Suppliers for all your construction needs
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">Skilled builders and construction experts dedicated to delivering only the best for our customers</div>
                        ...
                        <div className="flex lg:justify-end w-full lg:w-1/2" data-aos="fade-up" data-aos-delay="700">
                            <img alt="card img" className="rounded-t float-right duration-1000 w-full" src={sunset} />
                        </div>
                    </div>
                </div>
            </div>
